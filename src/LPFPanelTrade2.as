...
package {
    ...
    public class LPFPanelTrade extends LPFPanel {
        ...
        override public function fOpen(_arg1:Object):void{
            ...
            bg.tPane2.text = "Trade Options";
            bg.tPane3.text = "Your Offers";
            bg.tPane4.text = "Their Offers";
            _local2 = _arg1.r;
            x = _local2.x;
            if (_local2.y > -1){
                y = _local2.y;
            ...
            _local4.tabStates = MovieClip(fParent).getTabStates();
            _local4.sortOrder = ["Note", "Resource", "Item", "Quest Item", "ServerUse", "Refinement", "Bow", "Unarmed", "Sword", "Axe", "Dagger", "Gun", "Mace", "Polearm", "Staff", "Wand", "Class", "Armor", "Helm", "Cape", "Ring", "Amulet", "Belt", "Pet", "House", "Wall Item", "Floor Item"];
            _local4.filterMap = {
                Weapon:["Bow", "Unarmed", "Sword", "Axe", "Dagger", "Gun", "Mace", "Polearm", "Staff", "Wand"],
                ar:["Class", "Armor"],
                he:["Helm"],
                ba:["Cape"],
                pe:["Pet"],
