...
package {
    ...
    public class StatsviewMC extends MovieClip {
        ...
        public function StatsviewMC():void{
            ...
            bg.tTitle.text = "Character Name Stats";
        ...
        private function updateSpend():void{
            ...
            _local1.tClass.text = (((uoData.strClassName + "  (Rank ") + uoData.iRank) + ")");
            ...
            if (_local1.abilities.y > 188){
                _local1.abilities.y = 188;
            };
            var _local19:* = ["a1", "a2", "a3", "a4", "p1", "p2"];
            _local4 = 0;
            while (_local4 < _local19.length) {
                _local3 = _local19[_local4];
                _local18 = (_local1.abilities.getChildByName(_local3) as MovieClip);
                _local29 = rootClass.world.getActionByRef(_local3);
                if (_local29 == null){
