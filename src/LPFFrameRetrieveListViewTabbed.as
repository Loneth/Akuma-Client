...
package {
    ...
    public class LPFFrameRetrieveListViewTabbed extends LPFFrame {
        ...
        public function LPFFrameRetrieveListViewTabbed():void{
            listA = [];
            aSel = [];
            tabStates = [];
            filterMap = {};
        ...
        private function fDraw(_arg1:Boolean=true):void{
            var _local8:String;
            var _local10:LPFElementRetrieveListItemItem;
            ...
            while (iList.numChildren > 0) {
                LPFElementRetrieveListItemItem(iList.getChildAt(0)).fClose();
            };
            if (_arg1){
            ...
            while (_local6 < listA.length) {
                ...
                _local10 = new LPFElementRetrieveListItemItem();
