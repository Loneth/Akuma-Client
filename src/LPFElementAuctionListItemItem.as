...
package {
    ...
    public class LPFElementAuctionListItemItem extends LPFElementListItem {
		...
		public var tCopper:TextField;
		public var tSilver:TextField;
        ...
        public function LPFElementAuctionListItemItem():void{
        ...
        override protected function fDraw():void{
			...
			tCopper.htmlText = fData.Copper;
            tSilver.htmlText = fData.Silver;
            tGold.htmlText = fData.Gold;
            tCoins.htmlText = fData.Coins;
        ...
        override protected function onClick(_arg1:MouseEvent):void{
            ...
            if (!rootClass.isGreedyModalInStack()){
                if (!sel){
                    _local2 = LPFFrameAuctionListViewTabbed(fParent).getListItemByiSel();
                    if (_local2 != null){
                        _local2.deselect();
                    };
                    select();
