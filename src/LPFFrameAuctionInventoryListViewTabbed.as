...
//LPFFrameAuctionInventoryListViewTabbed
...
package {
    ...
    public class LPFFrameAuctionInventoryListViewTabbed extends LPFFrame {
        ...
        public function LPFFrameAuctionInventoryListViewTabbed():void{
            listA = [];
            aSel = [];
            tabStates = [];
            filterMap = {};
        ...
        private function fRefresh(_arg1:Object):void{
            if (("tabStates" in _arg1)){
                tabStates = _arg1.tabStates;
            };
            if (("filterMap" in _arg1)){
        ...
        private function fDraw(_arg1:Boolean=true):void{
            var _local8:String;
            var _local10:LPFElementAuctionInventoryListItemItem;
            ...
            while (iList.numChildren > 0) {
                LPFElementAuctionInventoryListItemItem(iList.getChildAt(0)).fClose();
            };
            if (_arg1){
            ...
            while (_local6 < listA.length) {
                ...
                _local10 = new LPFElementAuctionInventoryListItemItem();
        ...
        private function getTabByFilter(_arg1:String):Object{
            var _local2:Object;
            var _local3:int;
