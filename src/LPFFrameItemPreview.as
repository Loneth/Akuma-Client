...
package {
    ...
    public class LPFFrameItemPreview extends LPFFrame {
		...
		private function onBtnChatShowClick(_arg_1:Event):void
        {
			...
			rootClass.ui.mcInterface.te.htmlText = rootClass.ui.mcInterface.te.htmlText + " <a href='loadItem:"+ iSel.CharItemID +"'>&lt;" + itemFilterName + "&gt;</a> ";	
			rootClass.ui.mcInterface.te.htmlText = rootClass.ui.mcInterface.te.htmlText.replace(rootClass.chatF.regExpSPACE, " ");
