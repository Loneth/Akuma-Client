...
package {
    ...
    public class LPFLayoutRefineShop extends LPFLayout {
        ...
        public function LPFLayoutRefineShop():void{
            x = 0;
            y = 0;
            panels = [];
            fData = {};
        ...
        override public function fOpen(_arg1:Object):void{
            ...
            h = _local2.h;
            _local4 = {};
            _local4.panel = new LPFPanelRefineShop();
            _local3 = "Refine Shop";//rootClass.world.shopinfo.sName;
            _local4.fData = {
                items:itemsShop,
                itemsInv:itemsInv,
                sName:_local3,
        ...
        override protected function handleUpdate(_arg1:Object):Object{
			...
			if (_arg1.eventType == "vendingSelList"){
                iSel = null;
            ...
            if (_arg1.eventType == "refineItem"){
                if (iSel != null){
                    rootClass.world.sendRefineItemRequest(iSel);
                }
                else {
                    if (eSel != null){
                        rootClass.world.sendRefineItemRequest(eSel);
                    };
                };
            };
		...
		private function updatePreviewButtons2(_arg1:Object=null, _arg2:Object=null):void{
            var _local3:Object = {};
            if (((!((_arg1 == null))) && (!((_arg2 == null))))){
                _local3 = _arg2;
            } else {
                _local3.eventType = "previewButton2Update";
                _local3.fData = {};
                _local3.fData.sText = "";
                _local3.sMode = "grey";
                _local3.buttonNewEventType = "";
