...
package {
    ...
    public class LPFFrameForgeListViewTabbed extends LPFFrame {
        ...
        public function LPFFrameForgeListViewTabbed():void{
            listA = [];
            aSel = [];
            tabStates = [];
            filterMap = {};
        ...
        private function fDraw(_arg1:Boolean=true):void{
            var _local8:String;
            var _local10:LPFElementForgeListItemItem;
            ...
            while (_local6 < listA.length) {
                ...
                _local10 = new LPFElementListItemItem();
