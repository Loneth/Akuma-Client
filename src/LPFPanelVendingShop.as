...
package {
    ...
    public class LPFPanelVendingShop extends LPFPanel {

        public function LPFPanelVendingShop():void{
            x = 0;
            y = 0;
            frames = [];
            fData = {};
        ...
        override public function fOpen(_arg1:Object):void{
            ...
            _local4.fData = {msg:"<p align='center'>Select an item from the list. Below are the required parts to buy the desired item.</p>"};
            _local4.r = {
                x:-1,
                y:71,
                w:200,
            ...
            _local4.eventTypes = ["refreshItems", "vendingSel"];
			
            addFrame(_local4);
            _local4 = {};
            _local4.frame = new LPFFrameVendingCostDisplay();
            _local4.fData = null;
            _local4.r = {
                x:450, //450
                y:-140, //-90
