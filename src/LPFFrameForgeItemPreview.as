...
package {
    ...
    public class LPFFrameForgeItemPreview extends LPFFrame {
        ...
        public function LPFFrameForgeItemPreview():void{
            previewArgs = {};
        ...
        protected function fDraw():void{
            ...
            btnDelete.visible = true;
            if ((((getLayout().sMode.toLowerCase().indexOf("shop") > -1)) || (isShow))){
                btnDelete.visible = false;
            };
        }
