...
package {
    ...
    public class LPFFrameRefineCostDisplay extends LPFFrame {
        ...
        public function LPFFrameRefineCostDisplay():void{
            x = 0;
            y = 0;
            fData = {};
        }
        ...
        private function fDraw():void{
            ...
            if ((((getLayout().sMode.indexOf("shop") > -1)) && (!((fData == null))))){
				...
				*/
                ...
                var Copper = Number(fData.iRefineCopper);
				var FontColorCopper = "#FFFFFF";
				var Silver = Number(fData.iRefineSilver);
				var FontColorSilver = "#FFFFFF";
				var Gold = Number(fData.iRefineGold);
				var FontColorGold = "#FFFFFF";
				var Coins = Number(fData.iRefineCoins);
