...
package {
    ...
    public class LPFPanelBank extends LPFPanel {
        ...
        override public function fOpen(_arg1:Object):void{
            ...
            _local4.sName = "bank";
            _local4.itemEventType = "bankSel";
            _local4.tabEventType = "categorySel";
            _local4.eventTypes = ["refreshItems", "refreshBank", "categorySel"];
            ...
            addFrame(_local4);
            _local4 = {};
            _local4.frame = new LPFFrameStoredInventoryGoldDisplay();//LPFFrameGoldDisplay();
			_local4.fType = "Inventory";
			...
			addFrame(_local4);
			_local4 = {};
            _local4.frame = new LPFFrameStoredBankGoldDisplay();
			_local4.fType = "Bank";
            _local4.fData = fData.objData.bank;
            _local4.r = {
                x:-1,
                y:-70,
                w:-1,
			...
			//Select an item from your Inventory (right) to move that item to the Bank (left), and vice-versa.<br><br>Selecting an item from both lists allows you to perform a swap.
            _local4.r = {
                x:-1,
                y:42,
                w:200,
            ...
            _local4.eventTypes = ["bankSel", "inventorySel"];
            addFrame(_local4);
            _local4 = {};
            _local4.frame = new LPFFrameGenericButton();
            _local4.fData = null;
