...
//LPFElementAuctionInventoryListItemItem
...
package {
    ...
    public class LPFElementAuctionInventoryListItemItem extends LPFElementListItem {
        ...
        public function LPFElementAuctionInventoryListItemItem():void{
        ...
        override protected function onClick(_arg1:MouseEvent):void{
            ...
            if (!rootClass.isGreedyModalInStack()){
                if (!sel){
                    _local2 = LPFFrameAuctionInventoryListViewTabbed(fParent).getListItemByiSel();
                    if (_local2 != null){
                        _local2.deselect();
                    };
                    select();
