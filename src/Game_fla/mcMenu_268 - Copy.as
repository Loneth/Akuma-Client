...
package Game_fla{
    ...
    public dynamic class mcMenu_268 extends MovieClip {
        ...
        function frame1(){
			...
			btnSkillsPanel.addEventListener(MouseEvent.MOUSE_OVER, onMouseOver);
            btnSkillsPanel.addEventListener(MouseEvent.MOUSE_OUT, onMouseOut);
	        btnSkillsPanel.addEventListener(MouseEvent.CLICK, onMouseClick);
