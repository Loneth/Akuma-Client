...
package {
    ...
    public class LPFElementForgeListItemItem extends LPFElementListItem {
        ...
        public function LPFElementForgeListItemItem():void{
        ...
        override protected function fDraw():void{
            ...
            tName.htmlText = "<font color='#00FF00'>" + fData.iRefine + " " + _local3;//tName.htmlText = _local3;
            if (fData.iRty != null){
            };
        ...
        override protected function onClick(_arg1:MouseEvent):void{
            ...
            if (!rootClass.isGreedyModalInStack()){
                if (!sel){
                    _local2 = LPFFrameForgeListViewTabbed(fParent).getListItemByiSel();
                    if (_local2 != null){
                        _local2.deselect();
                    };
                    select();
